...
public class AuthenticatingFilter implements ContainerRequestFilter {
    @Override
    ...
    MySecurityContex msc = new MySecurityContex(null, scheme);
    ...
    try {
        ...
        String user= claims.getSubject();
         msc = new MySecurityContex(Eigenaar.getUserByName(user), scheme);
